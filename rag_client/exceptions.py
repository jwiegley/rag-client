...
class ConfigurationError(RAGClientError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            message=message, error_code="CONFIG_ERROR", context=context, **kwargs
        )
...
class IndexingError(RAGClientError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            message=message, error_code="INDEX_ERROR", context=context, **kwargs
        )
...
class RetrievalError(RAGClientError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            message=message, error_code="RETRIEVAL_ERROR", context=context, **kwargs
        )
...
class StorageError(RAGClientError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            message=message, error_code="STORAGE_ERROR", context=context, **kwargs
        )
...
class ProviderError(RAGClientError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            message=message, error_code="PROVIDER_ERROR", context=context, **kwargs
        )
...
class APIError(RAGClientError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            message=message, error_code=error_code, context=context, **kwargs
        )
